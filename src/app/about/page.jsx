        ...
        <div className='max-w-2xl mx-auto p-3 text-center'>
          <div>
            <h1 className='text-3xl font font-semibold text-center my-7'>
              About TechByte&apos;s Blog
            </h1>
            <div className='text-md text-gray-500 flex flex-col gap-6'>
              <p>
                Welcome to TechByte&apos;s Blog! Created by TechByte Ghavidel, this blog
                serves as a personal platform to share his insights and ideas with
                the world. TechByte is an enthusiastic developer who enjoys writing
              ...
              <p>
                ...
                engineering, and programming languages. TechByte is continually
